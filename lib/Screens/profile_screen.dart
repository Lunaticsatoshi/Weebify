...
import 'package:weebify/Screens/edit_profile_screen.dart';
...
import 'package:weebify/utilities/constants.dart';
...
class ProfileScreen extends StatefulWidget {
 ...
 final String userId;
 ProfileScreen({Key key,this.currentUserId,this.userId}) : super(key: key);
  @override
...
class _ProfileScreenState extends State<ProfileScreen> with AutomaticKeepAliveClientMixin{
  ...
  List<Post> _posts = [];
  int _displayPosts = 0; //0 for grid and 1 for column
  User _profileUser;
  @override
  void initState() { 
    super.initState();
  ...
  _displayButton(User user){
    return user.id == Provider.of<UserData>(context).currentUserId ? Container(   
                            ...
                            child: FlatButton(
                              ...
                              color: _isFollowing ? Colors.grey[200] : Colors.redAccent,
                    ...
                    Expanded(
                      child: Column(
                        children: <Widget>[
                          CircleAvatar(
                         radius: 50.0,
                         backgroundImage: user.profileImage.isEmpty ? AssetImage('assets/images/user_placeholder.jpg') : CachedNetworkImageProvider(user.profileImage),
                          ),
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Column(
                                  children: <Widget>[
                                    Text(_posts.length.toString(), style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.w600,
                                    ),
                                    ),
                                ...
                                Column(
                                  children: <Widget>[
                                    Text(_followerCount.toString(), style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.w600,
                                    ),
                                    ),
                                ...
                                Column(
                                  children: <Widget>[
                                    Text(_followingCount.toString(), style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.w600,
                                    ),
                                    ),
